...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'admin12345',
        'HOST': 'database-1.cllkljv1hjzt.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'projectbucket777' # please enter your s3 bucket name
