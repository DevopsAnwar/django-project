...
DATABASES = {
    'default': {
        ...
        'NAME': 'database-1-anwar', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': 'Admin12345',
        'HOST': 'database-1-anwar.cllkljv1hjzt.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-bucket-anwar' # please enter your s3 bucket name
